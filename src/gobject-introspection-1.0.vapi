...
namespace GI {
	...
	public class ArgInfo : GI.BaseInfo {
		...
		protected ArgInfo ();
		public int closure {get;}
		public int destroy {get;}
		public GI.Direction direction {get;}
		public GI.Transfer ownership_transfer {get;}
		public GI.ScopeType scope {get;}
	...
	[CCode (cheader_filename = "girepository.h", ref_function="g_base_info_ref",
	...
	public class CallableInfo : GI.BaseInfo {
		...
		public GI.Transfer caller_owns {get;}
		public int n_args {get;}
		public unowned string get_return_attribute (string name);
		public GI.TypeInfo return_type {get;}
	...
	public class EnumInfo : GI.BaseInfo {
		[CCode (has_construct_function = false)]
		protected EnumInfo ();
		public unowned string error_domain {get;}
		public GI.FunctionInfo get_method (int n);
		public int n_methods {get;}
		public int n_values {get;}
		public GI.TypeTag storage_type {get;}
	...
	public class FieldInfo : GI.BaseInfo {
		[CCode (has_construct_function = false)]
		protected FieldInfo ();
		public GI.FieldInfoFlags flags {get;}
	...
	public class InterfaceInfo : GI.BaseInfo {
		...
		public GI.FunctionInfo get_method (int n);
		public int n_constants {get;}
		public int n_methods {get;}
		public int n_prerequisites {get;}
		public int n_properties {get;}
		public int n_signals {get;}
		public int n_vfuncs {get;}
	...
	public class ObjectInfo : GI.BaseInfo {
		...
		public GI.FunctionInfo get_method (int n);
		public int n_constants {get;}
		public int n_fields {get;}
		public int n_interfaces {get;}
		public int n_methods {get;}
		public int n_properties {get;}
		public int n_signals {get;}
		public int n_vfuncs {get;}
	...
	public class PropertyInfo : GI.BaseInfo {
		...
		public GLib.ParamFlags flags {get;}
		public GI.Transfer ownership_transfer {get;}
		public GI.TypeInfo get_type ();
	}
	[CCode (cheader_filename = "girepository.h")]
	public class RegisteredTypeInfo : GI.BaseInfo {
		...
		public GLib.Type g_type {get;}
		public string type_init {get;}
		public string type_name {get;}
	}
	[CCode (cheader_filename = "girepository.h", 
			lower_case_cprefix = "g_irepository_",
			lower_case_csuffix = "irepository",
			type_id = "g_irepository_get_type ()")]
	...
	public class SignalInfo : GI.BaseInfo {
		...
		public GLib.SignalFlags flags {get;}
	...
	[CCode (cheader_filename = "girepository.h", cprefix="g_type_info_")]
	public class TypeInfo : GI.BaseInfo {
		[CCode (has_construct_function = false)]
		protected TypeInfo ();
		public int array_fixed_size {get;}
		public int array_length {get;}
		public GI.ArrayType array_type {get;}
		public GI.BaseInfo @interface {get;}
		public GI.TypeInfo get_param_type (int n);
		public GI.TypeTag tag {get;}
	...
	public class UnionInfo : GI.BaseInfo {
		...
		public int discriminator_offset {get;}
	...
	public class VFuncInfo : GI.CallableInfo {
		[CCode (has_construct_function = false)]
		protected VFuncInfo ();
		public GI.VFuncInfoFlags flags {get;}
