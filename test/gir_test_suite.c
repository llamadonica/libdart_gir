/* gir_test_suite.c generated by valac 0.20.1, the Vala compiler
...
gint test_main (gchar** args, int args_length1) {
	...
	GirDebugVisitor* _tmp2_;
	GirDebugVisitor* visitor;
	GirDebugVisitor* _tmp3_;
...
Namespace* namespace_new (GIRepository* repository, const gchar* namespace, GError** error) {
	...
	GIRepository* _tmp0_;
	const gchar* _tmp1_;
	NamespaceImpl* _tmp2_;
	NamespaceImpl* _tmp3_;
	GError * _inner_error_ = NULL;
	g_return_val_if_fail (repository != NULL, NULL);
	g_return_val_if_fail (namespace != NULL, NULL);
	_tmp0_ = repository;
	_tmp1_ = namespace;
	_tmp2_ = namespace_impl_new (_tmp0_, _tmp1_, &_inner_error_);
	_tmp3_ = _tmp2_;
	if (_inner_error_ != NULL) {
		g_propagate_error (error, _inner_error_);
		return NULL;
	}
	result = (Namespace*) _tmp3_;
	return result;
}
	...
	gir_visitor_visit_namespace (_tmp0_, (Namespace*) self);
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				GIBaseInfo* _tmp12_;
				BaseInfoImpl* _tmp13_;
				BaseInfoImpl* _tmp14_;
				GirVisitor* _tmp15_;
				_tmp2_ = _tmp1_;
				if (!_tmp2_) {
					gint _tmp3_;
				...
				_tmp6_ = self->priv->_namespace;
				_tmp7_ = g_irepository_get_n_infos (_tmp5_, _tmp6_);
				if (!(_tmp4_ < _tmp7_)) {
					break;
				}
				_tmp8_ = self->priv->_repository;
				_tmp9_ = self->priv->_namespace;
				_tmp10_ = i;
				_tmp11_ = g_irepository_get_info (_tmp8_, _tmp9_, _tmp10_);
				_tmp12_ = _tmp11_;
				_tmp13_ = base_info_impl_new (_tmp12_);
				_tmp14_ = _tmp13_;
				_tmp15_ = visitor;
